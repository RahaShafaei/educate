...
public class OrgPostEntity {
    ...
    @Id
    @jakarta.persistence.Column(name = "org_post_id", nullable = false)
    ...
    public void setOrgPostId(int orgPostId) {
    ...
    public boolean equals(Object o) {
        ...
        OrgPostEntity that = (OrgPostEntity) o;

        if (orgPostId != that.orgPostId) return false;
