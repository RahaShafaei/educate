USE [master]
GO
/****** Object:  Database [educate]    Script Date: 3/17/2024 9:39:02 AM ******/
...
USE [educate]
GO
/****** Object:  UserDefinedFunction [dbo].[fn_date_time_rand]    Script Date: 3/17/2024 9:39:02 AM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  View [dbo].[vw_getRANDValue]    Script Date: 3/17/2024 9:39:02 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[assessment]    Script Date: 3/17/2024 9:39:02 AM ******/
SET ANSI_NULLS ON
    GO
    SET QUOTED_IDENTIFIER ON
    GO
...
[id] ASC
    ...
    GO
/****** Object:  Table [dbo].[attendance]    Script Date: 3/17/2024 9:39:02 AM ******/
    SET ANSI_NULLS ON
    GO
    SET QUOTED_IDENTIFIER ON
    GO
...
[id] ASC
    ...
    GO
/****** Object:  Table [dbo].[element]    Script Date: 3/17/2024 9:39:02 AM ******/
    SET ANSI_NULLS ON
    GO
    SET QUOTED_IDENTIFIER ON
    GO
...
[id] ASC
    ...
    GO
/****** Object:  Table [dbo].[element_grp]    Script Date: 3/17/2024 9:39:02 AM ******/
    SET ANSI_NULLS ON
    GO
    SET QUOTED_IDENTIFIER ON
    GO
...
[id] ASC
    ...
    GO
/****** Object:  Table [dbo].[location]    Script Date: 3/17/2024 9:39:02 AM ******/
    SET ANSI_NULLS ON
    GO
    SET QUOTED_IDENTIFIER ON
    GO
...
[id] ASC
    ...
    GO
/****** Object:  Table [dbo].[meeting]    Script Date: 3/17/2024 9:39:02 AM ******/
    SET ANSI_NULLS ON
    GO
    SET QUOTED_IDENTIFIER ON
    GO
...
[id] ASC
    ...
    GO
/****** Object:  Table [dbo].[org_post]    Script Date: 3/17/2024 9:39:02 AM ******/
    SET ANSI_NULLS ON
    GO
    SET QUOTED_IDENTIFIER ON
    GO
...
[id] ASC
    ...
    GO
/****** Object:  Table [dbo].[org_unit]    Script Date: 3/17/2024 9:39:02 AM ******/
    SET ANSI_NULLS ON
    GO
    SET QUOTED_IDENTIFIER ON
    GO
...
[id] ASC
    ...
    GO
/****** Object:  Table [dbo].[org_unit_post_person]    Script Date: 3/17/2024 9:39:02 AM ******/
    SET ANSI_NULLS ON
    GO
    SET QUOTED_IDENTIFIER ON
    GO
...
[id] ASC
    ...
    GO
/****** Object:  Table [dbo].[person]    Script Date: 3/17/2024 9:39:02 AM ******/
    SET ANSI_NULLS ON
    GO
    SET QUOTED_IDENTIFIER ON
    GO
...
[id] ASC
    ...
    GO
/****** Object:  Table [dbo].[person_role]    Script Date: 3/17/2024 9:39:02 AM ******/
    SET ANSI_NULLS ON
    GO
    SET QUOTED_IDENTIFIER ON
    GO
...
[id] ASC
    ...
    GO
/****** Object:  Table [dbo].[plan_process]    Script Date: 3/17/2024 9:39:02 AM ******/
    SET ANSI_NULLS ON
    GO
    SET QUOTED_IDENTIFIER ON
    GO
CREATE TABLE [dbo].[plan_process](
    ...
    [deleted_at] [datetime] NULL,
    [inserted_at] [datetime] NULL,
    CONSTRAINT [PK_plan_process] PRIMARY KEY CLUSTERED
(
[id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
    ) ON [PRIMARY]
    GO
/****** Object:  Table [dbo].[plans]    Script Date: 3/17/2024 9:39:02 AM ******/
    SET ANSI_NULLS ON
    GO
    SET QUOTED_IDENTIFIER ON
    GO
...
[id] ASC
    ...
    GO
/****** Object:  Table [dbo].[plans2]    Script Date: 3/17/2024 9:39:02 AM ******/
    SET ANSI_NULLS ON
    GO
    SET QUOTED_IDENTIFIER ON
    GO
CREATE TABLE [dbo].[plans2](
    [id] [int] IDENTITY(1,1) NOT NULL,
    [org_unit_id] [int] NULL,
    [location_id] [int] NULL,
    [pr_course_id] [int] NULL,
    ...
    GO
/****** Object:  Table [dbo].[pr_course]    Script Date: 3/17/2024 9:39:02 AM ******/
    SET ANSI_NULLS ON
    GO
    SET QUOTED_IDENTIFIER ON
    GO
...
[id] ASC
    ...
    GO
/****** Object:  Table [dbo].[pr_course_grp]    Script Date: 3/17/2024 9:39:02 AM ******/
    SET ANSI_NULLS ON
    GO
    SET QUOTED_IDENTIFIER ON
    GO
...
[id] ASC
    ...
    GO
/****** Object:  Table [dbo].[process]    Script Date: 3/17/2024 9:39:02 AM ******/
    SET ANSI_NULLS ON
    GO
    SET QUOTED_IDENTIFIER ON
    GO
...
[id] ASC
    ...
    GO
/****** Object:  Table [dbo].[roles]    Script Date: 3/17/2024 9:39:02 AM ******/
    SET ANSI_NULLS ON
    GO
    SET QUOTED_IDENTIFIER ON
    GO
...
ALTER TABLE [dbo].[person_role] ADD  CONSTRAINT [DF_person_role_inserted_at]  DEFAULT (sysdatetime()) FOR [inserted_at]
    GO
ALTER TABLE [dbo].[plan_process] ADD  CONSTRAINT [DF_plan_process_deleted]  DEFAULT ((0)) FOR [deleted]
    GO
ALTER TABLE [dbo].[plan_process] ADD  CONSTRAINT [DF_plan_process_inserted_at]  DEFAULT (sysdatetime()) FOR [inserted_at]
    GO
...
ALTER TABLE [dbo].[person_role] CHECK CONSTRAINT [FK_person_role_role]
    GO
ALTER TABLE [dbo].[plan_process]  WITH CHECK ADD  CONSTRAINT [FK_plan_process_plans] FOREIGN KEY([plan_id])
    REFERENCES [dbo].[plans] ([id])
    GO
ALTER TABLE [dbo].[plan_process] CHECK CONSTRAINT [FK_plan_process_plans]
    GO
ALTER TABLE [dbo].[plan_process]  WITH CHECK ADD  CONSTRAINT [FK_plan_process_process] FOREIGN KEY([process_id])
    REFERENCES [dbo].[process] ([id])
    GO
ALTER TABLE [dbo].[plan_process] CHECK CONSTRAINT [FK_plan_process_process]
    GO
...
ALTER TABLE [dbo].[plans] CHECK CONSTRAINT [FK_plans_element_holding]
    GO
ALTER TABLE [dbo].[plans]  WITH CHECK ADD  CONSTRAINT [FK_plans_element_phase] FOREIGN KEY([element_id_phase])
    REFERENCES [dbo].[element] ([id])
    GO
ALTER TABLE [dbo].[plans] CHECK CONSTRAINT [FK_plans_element_phase]
    GO
...
ALTER TABLE [dbo].[plans] CHECK CONSTRAINT [FK_plans_element_project]
    GO
ALTER TABLE [dbo].[plans]  WITH CHECK ADD  CONSTRAINT [FK_plans_location] FOREIGN KEY([location_id])
    REFERENCES [dbo].[location] ([id])
    GO
ALTER TABLE [dbo].[plans] CHECK CONSTRAINT [FK_plans_location]
    GO
...
ALTER TABLE [dbo].[plans] CHECK CONSTRAINT [FK_plans_person]
    GO
ALTER TABLE [dbo].[plans]  WITH CHECK ADD  CONSTRAINT [FK_plans_person_supervisor] FOREIGN KEY([person_id_supervisor])
    REFERENCES [dbo].[person] ([id])
    GO
ALTER TABLE [dbo].[plans] CHECK CONSTRAINT [FK_plans_person_supervisor]
    GO
...
ALTER TABLE [dbo].[process] CHECK CONSTRAINT [FK_process_pr_course]
    ...
    GO
    EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'0 for false, 1 for true' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'plan_process', @level2type=N'COLUMN',@level2name=N'deleted'
    GO
