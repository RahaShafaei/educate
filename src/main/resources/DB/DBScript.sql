USE [master]
GO
/****** Object:  Database [educate]    Script Date: 11/1/2023 10:43:11 AM ******/
CREATE DATABASE [educate]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'educate', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER\MSSQL\DATA\educate.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
...
USE [educate]
GO
/****** Object:  UserDefinedFunction [dbo].[fn_date_time_rand]    Script Date: 11/1/2023 10:43:11 AM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  View [dbo].[vw_getRANDValue]    Script Date: 11/1/2023 10:43:11 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[attendance]    Script Date: 11/1/2023 10:43:11 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[attendance](
	...
	[org_unit_post_person_id] [int] NULL,
	[plan_id] [int] NULL,
	[element_id] [int] NULL,
	[grade] [float] NULL,
	[deleted] [char](2) NULL,
...
GO
/****** Object:  Table [dbo].[element]    Script Date: 11/1/2023 10:43:11 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[element_grp]    Script Date: 11/1/2023 10:43:11 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[meeting]    Script Date: 11/1/2023 10:43:11 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[org_post]    Script Date: 11/1/2023 10:43:11 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[org_unit]    Script Date: 11/1/2023 10:43:11 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[org_unit_post_person]    Script Date: 11/1/2023 10:43:11 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[person]    Script Date: 11/1/2023 10:43:11 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[person_role]    Script Date: 11/1/2023 10:43:11 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[plans]    Script Date: 11/1/2023 10:43:11 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[pr_course]    Script Date: 11/1/2023 10:43:11 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[pr_course_grp]    Script Date: 11/1/2023 10:43:11 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[roles]    Script Date: 11/1/2023 10:43:11 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
ALTER TABLE [dbo].[attendance]  WITH CHECK ADD  CONSTRAINT [FK_attendance_person] FOREIGN KEY([org_unit_post_person_id])
REFERENCES [dbo].[org_unit_post_person] ([id])
GO
...
GO
ALTER TABLE [dbo].[plans]  WITH CHECK ADD  CONSTRAINT [FK_plan_org_unit_post_person] FOREIGN KEY([org_unit_post_person_id])
REFERENCES [dbo].[org_unit_post_person] ([id])
GO
ALTER TABLE [dbo].[plans] CHECK CONSTRAINT [FK_plan_org_unit_post_person]
GO
